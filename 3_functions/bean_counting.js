...
// by writing "string"[N]. The returned value will be a string
// containing only one character (for example, "b"). The first
// character has position 0, which causes the last one to be
// found at position string.length - 1. In other words, a
...
// character that is to be counted (rather than counting only
// uppercase “B” characters). Rewrite countBs to make use of
// this new function.
